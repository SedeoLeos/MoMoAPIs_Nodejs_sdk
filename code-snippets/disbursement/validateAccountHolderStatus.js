...
const validateAccountHolderStatus = async (accountHolderID, accountHolderType, debug = false) => {
  try {
    /**
    ...
    const response = await disbursement.validateAccountHolderStatus(accountHolderID, accountHolderType);
 ...
 * Invoke the function
 */
validateAccountHolderStatus(accountHolderID, accountHolderType, false);
